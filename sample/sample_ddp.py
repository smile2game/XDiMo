...
def main(args):
    ...
    print(f"args.model is {args.model}")
    ...
    print(f"finish load model,model is {model}")
    ...
    print(f"finish load state_dict,model is {model}")
...
if __name__ == "__main__":
    ...
    _root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    parser.add_argument("--config", type=str, default=os.path.join(_root, "configs", "ffs", "ffs_sample.yaml"))
    parser.add_argument("--ckpt", type=str, default=None, help="e.g. ./ckpts/trained/010-Latte-L-2-MoE-F16S3-ffs-Gc-Amp/0270000.pt")
    parser.add_argument("--save_video_path", type=str, default=os.path.join(_root, "output", "samples"))
