...
# --real_data_path /public/home/liuhuijie/dits/Latte/test/real_frames \
# --fake_data_path /public/home/liuhuijie/dits/Latte/test/real_frames \
# --mirror 0 --gpus 1 --resolution 256 \
# --metrics fvd2048_16f  \
# --verbose 1 --use_cache 0
