...
class MoETransformerBlock(nn.Module):
    """
    A Latte transformer block with MoE (Mixture of Experts) layer.
    """
...
Latte_models = {
    ...
    'Latte_XL_2_MoE':  Latte_XL_2_MoE, 
    'Latte-L/2-MoE': Latte_L_2_MoE,  # 新增 MoE 版本的 L 模型
}
...
if __name__ == '__main__':
    ...
    original_model = Latte_XL_2().to(device)
